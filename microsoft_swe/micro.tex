...
\begin{tabularx}{\textwidth}{@{} X r @{}}
    \begin{minipage}[t]{\textwidth}
       ...
       \href{sj99@illinois.edu}{\textbf{Email:} \color{Blue}\textit{sj99@illinois.edu}}  $|$ 
        ...
        \textbf{Seeking Software Engineer Roles for 2026} \hfill
...
\section{\fontsize{14}{12}\selectfont EDUCATION}
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Computer Security, Deep Learning For Computer Vision, Advanced Distributed Computing, Cloud Networking}
    \resumeItemListEnd
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Distributed Systems, Computer Networks, Operating Systems, Software Design Principles, Digital Design}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
    {Cloud Engineer}{January 2025 -- April 2025}
    {Nexus}{Remote, USA}
    \resumeItemListStart
...
\resumeSubHeadingListStart
    ...
    \resumeProjectHeading
    {\projectHeadingColor\textbf{Study Buddy} $|$ {Full-Stack iOS Developer} $|$ \emph{\color{Black}SwiftUI, Firebase, CoreData, Authentication}}{}
    \resumeItemListStart
...
\begin{tabularx}{\textwidth}{@{\hspace{0.10in}}p{4cm}X@{}}
    ...
    \textbf{AI/ML Frameworks:} & PyTorch, Torchvision, OpenCV, MediaPipe, CNN, dlib \\
    \textbf{Cloud \& DevOps:} & AWS \{CDK, Lambda, SQS, S3, ECS, CloudWatch\}, CI/CD, GitHub Actions \\
    \textbf{Development \& Security:} & Spring Batch, JUnit, Mockito, Git, RESTful APIs, Authentication, Network Programming \\
    \textbf{Databases \& Tools:} & MySQL, Firebase, DynamoDB, Linux, Ansible, JSON, XML
\end{tabularx}
} 
