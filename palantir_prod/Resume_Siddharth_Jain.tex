...
\begin{tabularx}{\textwidth}{@{} X r @{}}
    \begin{minipage}[t]{\textwidth}
       ...
       \href{sj99@illinois.edu}{\textbf{Email:} \color{Blue}\textit{sj99@illinois.edu}}  $|$ 
        ...
        \textbf{Seeking Production Engineer (Early Career) Role At Palantir} \hfill
...
\section{\fontsize{14}{12}\selectfont EDUCATION}
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Advanced Distributed Computing, Computer Security, Cloud Networking, Deep Learning For Computer Vision}
    \resumeItemListEnd
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Data Structures \& Algorithms, Operating Systems, Distributed Systems, Software Design Principles, Computer Networks}
    \resumeItemListEnd
