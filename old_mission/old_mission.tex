...
\begin{tabularx}{\textwidth}{@{} X r @{}}
    \begin{minipage}[t]{\textwidth}
       ...
       \href{sj99@illinois.edu}{\textbf{Email:} \color{Blue}\textit{sj99@illinois.edu}}  $|$ 
        ...
        \textbf{Seeking Quantitative Trading Developer Role} \hfill
...
\section{\fontsize{14}{12}\selectfont EDUCATION}
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Data Structures \& Algorithms, Operating Systems, Distributed Systems, Computer Networks, Software Design Principles}
    \resumeItemListEnd
...
\begin{tabularx}{\textwidth}{@{\hspace{0.10in}}p{4cm}X@{}}
    ...
    \textbf{Systems Programming:} & Linux, Git, JUnit, Spring Batch, XML, JSON, Ansible, tmux \\
    \textbf{Data \& Algorithms:} & MySQL, JDBC, PyTorch, OpenCV, Data Structures, Algorithms \\
    \textbf{Web \& Cloud:} & React.js, AWS \{CDK, Lambda, SQS, S3, RDS, EC2, API-Gateway, CloudWatch\}, Firebase
\end{tabularx}
} 
