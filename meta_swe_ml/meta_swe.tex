...
\begin{tabularx}{\textwidth}{@{} X r @{}}
    \begin{minipage}[t]{\textwidth}
       ...
       \href{sj99@illinois.edu}{\textbf{Email:} \color{Blue}\textit{sj99@illinois.edu}}  $|$ 
        ...
        \textbf{Seeking ML Research Infrastructure Engineer Role} \hfill
...
\begin{tabularx}{\textwidth}{@{\hspace{0.10in}}p{4cm}X@{}}
    \textbf{Languages:} & Python, Java, C/C++, TypeScript, JavaScript \\
    \textbf{ML \& Research:} & PyTorch, Torchvision, OpenCV, CNN, MediaPipe, CoreML \\
    \textbf{Infrastructure \& Tools:} & Git, JUnit, Ansible, tmux, Linux, XML, JSON, MySQL, JDBC \\
    \textbf{Cloud \& Systems:} & AWS \{CDK, Lambda, SQS, S3, RDS, EC2, ECS, EFS, API-Gateway, CloudWatch\}
\end{tabularx}
} 
