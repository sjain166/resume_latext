...
\begin{tabularx}{\textwidth}{@{} X r @{}}
    \begin{minipage}[t]{\textwidth}
       ...
       \href{sj99@illinois.edu}{\textbf{Email:} \color{Blue}\textit{sj99@illinois.edu}}  $|$ 
        ...
        \textbf{Seeking Backend Engineer Role} \hfill
...
\section{\fontsize{14}{12}\selectfont EDUCATION}
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Distributed Systems, Software Design Principles, Operating Systems, Data Structures \& Algorithms, Computer Networks}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
    {Backend Engineer Intern}{May 2025 -- Current}
    {PayPal Inc. (Credits Teams - Buy Now Pay Later)}{Scottsdale, AZ}
    \resumeItemListStart
    ...
    {Amazon.com (3rd Party Payments Team)}{San Diego, CA}
    \resumeItemListStart
...
\begin{tabularx}{\textwidth}{@{\hspace{0.10in}}p{4cm}X@{}}
    ...
    \textbf{Backend \& Systems:} & Spring Batch, MySQL, JDBC, Git, JUnit, Linux, XML, JSON \\
    \textbf{Distributed Systems:} & AWS \{CDK, Lambda, SQS, S3, ECS, EFS, EC2, RDS, API-Gateway, CloudWatch\} \\
    \textbf{Authentication \& Tools:} & Firebase \{Auth, Firestore\}, RESTful APIs, Ansible, tmux, CoreML, CocoaPods
\end{tabularx}
} 
