...
\begin{tabularx}{\textwidth}{@{} X r @{}}
    \begin{minipage}[t]{\textwidth}
       ...
       \href{sj99@illinois.edu}{\textbf{Email:} \color{Blue}\textit{sj99@illinois.edu}}  $|$ 
        ...
        \textbf{Seeking New Grad SWE 2026} \hfill
...
\section{\fontsize{14}{12}\selectfont EDUCATION}
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Computer Networks, Digital Design, Distributed Systems, Operating Systems, Software Design Principles}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    {Arizona State University}{Tempe, AZ}
    \resumeItemListStart
        \resumeItem{Served as a course assistant for Introduction to Java, Data Structures \& Algorithms, and Introduction to Theoretical Computer Science.}
        \resumeItem{Collaborated with teaching staff to design weekly lesson plans focused on the course material and student-focused questions.}
        \resumeItem{Held office hours to address assignment-related questions and provided personalized feedback on coding assignments.}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    \resumeProjectHeading
    {\projectHeadingColor\textbf{FastOrder} $|$ {Full Stack Engineer} $|$ \emph{\color{Black} C\#, ASP.NET, WCF, RESTful}}{}
    \resumeItemListStart
        \resumeItem{Deployed a \textbf{Service-Oriented Web App}, using \textbf{ASP.NET}, on Web Server that imitates an E-Commerce Site for 1000+ users.}
        \resumeItem{Executed 3+ \textbf{ASPX pages}, for Users and Staff, calling Web Services to encrypt data, store cookies, update cart and pay.}
        \resumeItem{Created 5+ \textbf{WCF \& RESTful Services} to manipulate XML files data, eliminating the need of Database by 100\%.}
    \resumeItemListEnd

    \resumeProjectHeading
    {\projectHeadingColor\textbf{Rent Linkers} $|$ {Full Stack Engineer} $|$\emph{\color{Black} React.js, Python, Web3, ETH-Blockchain}}{}
    \resumeItemListStart
        \resumeItem{Led team of 4 to develop MVP of Blockchain-based Web3 DApp facilitating tech rental using Python and React.js, ETH-Chain.}
        \resumeItem{Upgraded Decentralized-Dispute-Mechanism to reduce on-chain computation by 80\%, utilizing Cartesi Rollback DApp Framework.}
        \resumeItem{Secured 3 prestigious awards: Best Utilization of Cartesi, Most Unique Concept, and 4th Place Overall for Project Implementation.}
    \resumeItemListEnd

    \resumeProjectHeading
    {\projectHeadingColor\textbf{VeMove} $|$ {Full Stack Engineer} $|$\emph{\color{Black} React.js, Python, Web3, ETH-Blockchain}}{}
    \resumeItemListStart
        \resumeItem{Built a blockchain-powered platform on VeChain using Solidity under 36 hours to track eco-friendly user travel and issue reward tokens.}
        \resumeItem{Designed custom movement detection algorithms, earning a \textbf{\$1000 travel scholarship} for innovation in sustainable mobility.}
        \resumeItem{Developed a full-stack web app with \textbf{Next.js and integrated Google Maps API} for precise user tracking and automated rewards.}
    \resumeItemListEnd
...
\begin{tabularx}{\textwidth}{@{\hspace{0.10in}}p{4cm}X@{}}
    ...
    \textbf{Development:} & iOS \{SwiftUI\}, Web \{ASP.NET, RestAPI, WSDL, React.js\} \\
    \textbf{Databases and Tools:} & MySQL, JDBC, Git, JUnit 5, Spring Batch, XML, JSON, Linux, CoreML, CocoaPods \\
    \textbf{Cloud Services:} & AWS \{CDK, Lambda, SQS, S3, RDS, EC2, API-Gateway\}, Firebase \{Auth, Firestore\}
\end{tabularx}
} 
