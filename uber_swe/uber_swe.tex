...
\begin{tabularx}{\textwidth}{@{} X r @{}}
    \begin{minipage}[t]{\textwidth}
       ...
       \href{sj99@illinois.edu}{\textbf{Email:} \color{Blue}\textit{sj99@illinois.edu}}  $|$ 
        ...
        \textbf{Seeking Software Engineer - Backend Java Role For 2026} \hfill
...
\section{\fontsize{14}{12}\selectfont EDUCATION}
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Advanced Distributed Computing, Deep Learning For Computer Vision, Computer Security, Cloud Networking}
    \resumeItemListEnd
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Data Structures \& Algorithms, Distributed Systems, Operating Systems, Software Design Principles, Computer Networks}
    \resumeItemListEnd
...
\begin{tabularx}{\textwidth}{@{\hspace{0.10in}}p{4cm}X@{}}
    \textbf{Languages:} & Java, Python, C/C++, TypeScript, C\# \\
    \textbf{Distributed Systems:} & AWS \{CDK, Lambda, SQS, S3, EC2, ECS, CloudWatch\}, Spring Batch, Microservices \\
    \textbf{Automation \& Tools:} & JUnit 5, Mockito, WireMock, Git, Ansible, Docker, CI/CD Pipelines \\
    \textbf{AI/ML \& Frameworks:} & PyTorch, OpenCV, TensorFlow, ASP.NET, React.js, RESTful APIs
\end{tabularx}
} 
