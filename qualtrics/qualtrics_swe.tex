...
\begin{tabularx}{\textwidth}{@{} X r @{}}
    \begin{minipage}[t]{\textwidth}
       ...
       \href{sj99@illinois.edu}{\textbf{Email:} \color{Blue}\textit{sj99@illinois.edu}}  $|$ 
        ...
        \textbf{Seeking Qualtrics Customer Care SWE} \hfill
...
\section{\fontsize{14}{12}\selectfont EDUCATION}
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Data Structures \& Algorithms, Software Design Principles, Distributed Systems, Operating Systems, Computer Networks}
    \resumeItemListEnd
...
\begin{tabularx}{\textwidth}{@{\hspace{0.10in}}p{4cm}X@{}}
    \textbf{Languages:} & Python, Node.js, Java, TypeScript, C/C++, C\# \\
    \textbf{Web Frameworks:} & ASP.NET, React.js, RESTful APIs, WCF, Express.js \\
    \textbf{AWS \& Cloud:} & AWS \{CDK, Lambda, SQS, S3, EC2, ECS, CloudWatch\}, Docker \\
    \textbf{Testing \& Tools:} & JUnit 5, Mockito, WireMock, Git, Spring Batch, MySQL, Linux
\end{tabularx}
} 
