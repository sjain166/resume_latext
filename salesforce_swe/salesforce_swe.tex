...
\begin{tabularx}{\textwidth}{@{} X r @{}}
    \begin{minipage}[t]{\textwidth}
       ...
       \href{sj99@illinois.edu}{\textbf{Email:} \color{Blue}\textit{sj99@illinois.edu}}  $|$ 
        ...
        \textbf{Seeking Software Engineer Role For 2026} \hfill
...
\section{\fontsize{14}{12}\selectfont EDUCATION}
    ...
    \resumeItemListStart
        \resumeItem{Courses Taken: Advanced Distributed Computing, Computer Security, Cloud Networking, Deep Learning in Computer Vision }
    \resumeItemListEnd
...
\begin{tabularx}{\textwidth}{@{\hspace{0.10in}}p{4cm}X@{}}
    ...
    \textbf{Cloud \& Platforms:} & AWS \{CDK, Lambda, SQS, S3, EC2, ECS, CloudWatch\}, Firebase \{Auth, Firestore\} \\
    \textbf{Testing \& Automation:} & JUnit 5, Mockito, WireMock, Spring Batch, CI/CD Pipelines, Git \\
    \textbf{Web \& Frameworks:} & React.js, SwiftUI, ASP.NET, RESTful APIs, HTML, JSON, XML
\end{tabularx}
} 
